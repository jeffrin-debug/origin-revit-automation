# send_command.ps1 - drive the ceiling bridge from outside Revit.
#
#   .\send_command.ps1 probe_background_open.py
#   .\send_command.ps1 probe_newrooms2.py -TimeoutSec 300
#
...
if (-not (Test-Path $hbPath)) {
    throw "No heartbeat.json. Open dynamo\ORIGIN Ceiling Bridge.dyn in Dynamo and set run mode to Periodic."
}

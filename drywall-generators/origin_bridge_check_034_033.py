# origin_bridge_check_034_033.py - run via the ORIGIN Bridge. READ-ONLY.
# Full dump + real overlap check for the DP-034-002* vs DP-033-004* conflict found on "Project8" -
# the neighbor-board trim reported it "would erase the board" and left both untouched, so this
# checks whether that's a genuine large containment (not a small corner sliver) before deciding
# on a fix.
import clr
...
TARGET_MARKS = ["DP-034-002A", "DP-034-002B", "DP-033-004A", "DP-033-004B"]
...
overlaps = {
    "A_pair": real_overlap("DP-034-002A", "DP-033-004A"),
    "B_pair": real_overlap("DP-034-002B", "DP-033-004B"),
}

OUT = {"elements": out, "wall_info": wall_info, "overlaps": overlaps}

# Origin Wall Assembly Generator v4 - PHASE 1 + PHASE 2 (FRAMING + DRYWALL)  [REVIT 2025 BUILD]
# Dynamo Python Script node for Revit 2025 (Dynamo CPython3 / Python 3.9 engine).
#
# WHY A 2025 BUILD: the NVIDIA Omniverse Revit Connector supports Revit 2025 (not 2026/2027). This
# file is kept in lockstep with origin_wall_assembly_v4_phase2.py (the 2027 build); the only
# differences are this header and a distinct MANIFEST_PATH. In Dynamo 2025 pick the "CPython3"
# engine. Version-tolerant: eid_value() handles the ElementId change; no f-strings are used.
#
# WHAT THIS IS:
...
WRITE_MANIFEST = True
MANIFEST_PATH = r"C:\Users\Origoncad\Downloads\origin_revit_drywall_scripts_v2_two_faces\origin_assembly_manifest_r2025.json"
